    ...
    <div class="container">
        <div class="row top-header">
            ...
            <div class="col-sm-4 logo-col text-center">
                <a href="{{ route('index') }}"><img src="{{ asset('images/logo-white-green.png') }}" alt=""></a>
            </div>
...
<section class="row featured-post-carousel">
    <div class="item post">
        <img src="{{ asset('images/featured-posts/1-2.jpg') }}" alt="" class="img-responsive main-bg">
        <div class="post-content">
            <div class="container">
                <h5 class="post-meta"><i>in</i> <a href="#">Author Profile</a> | <a href="#">feb 17, 2016</a></h5>
                <h2 class="post-title"><a href="{{ route('article') }}">Nature, in the broadest sense, is the natural, physical, or material world or universe.</a></h2>
                <a href="{{ route('article') }}" class="btn btn-primary"><span>read more</span></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row" id="post-masonry">
            ...
            <article class="col-sm-4 post post-masonry post-format-image">
                <div class="post-wrapper row">
                    <div class="featured-content row">
                        <a href="{{ route('article') }}"><img src="{{ asset('images/posts/masonry/1.jpg') }}" alt="" class="img-responsive"></a>
                    </div>
                    <div class="post-excerpt row">
                        ...
                        <h3 class="post-title"><a href="{{ route('article') }}">Nature, in the broadest sense, is the natural, physical, or material world or universe.</a></h3>
                        ...
                        <footer class="row">
                            ...
                            <div class="response-count"><img src="{{ asset('images/comment-icon-gray.png') }}" alt="">5</div>
                        </footer>
                    </div>
                </div>
            </article>
            ...
            <aside class="col-sm-4 widget-author widget widget-with-posts post">
                <div class="widget-author-inner row">
                    ...
                    <a href="#"><h2 class="author-name">张书贤</h2></a>
                ...
                {{--<div class="post-wrapper row">--}}
                    {{--<div class="featured-content row">--}}
                        {{--<div class="gallery-of-post">--}}
                            {{--<div class="item"><img src="{{ asset('images/posts/masonry/3.jpg') }}" alt=""></div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<div class="post-excerpt row">--}}
                        {{--<h5 class="post-meta">--}}
                ...
                <div class="post-wrapper row">
                    <div class="post-excerpt row">
                        ...
                        <footer class="row">
                            ...
                            <div class="response-count"><img src="{{ asset('images/comment-icon-white.png') }}" alt="">5</div>
                        </footer>
                    </div>
                </div>
            </article>
